<template>
  ...
  >
    <v-container>
      <v-row class="justify-center algin-left mt-1">
        <v-col cols="12" md="8">
          <v-app-bar height="44px" color="primary" v-model="appBar" fixed>
            <v-btn icon>
              <v-icon>mdi-dots-grid mdi-light</v-icon>
            </v-btn>
            <nuxt-link to="/">
              <v-btn icon>
                <v-icon>mdi-trello mdi-light</v-icon>
              </v-btn>
            </nuxt-link>
            <nuxt-link to="/">
              <h2 class="trello-logo">Trello</h2>
            </nuxt-link>
            <v-spacer></v-spacer>
            <v-menu
              transition
              ...
              <v-card>
                ...
                <v-list>
                  <v-list-item>
                    ...
                    <v-list-item-content>
                      <v-list-item-title>Sign as in</v-list-item-title>
                      <v-list-item-subtitle>
                        {{ $nuxt.$fire.auth.currentUser.email }}</v-list-item-subtitle>
                    </v-list-item-content>
                  </v-list-item>
                </v-list>
                <v-divider></v-divider>
                <v-list>
                  <v-list-item>
                    <v-list-item-title class="d-flex flex-column align-center">
                      <v-btn
                        class="logout"
                        color="primary"
                        flat
    ...
    <h1>{{ board.title }}</h1>
    <v-icon medium @click="deleteBoard()">mdi-delete-outline</v-icon>
    </div>
